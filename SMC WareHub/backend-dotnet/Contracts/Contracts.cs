...
public sealed record DeviceRequest(string? Ma, string? Ten, string? Loai, string? Model, string? Cpu, string? Ram, string? Storage, string? UserName = null, DateOnly? RegisteredAt = null, string? PhongBan = null, string? GhiChu = null, string? Producer = null, string? IpAddress = null);
